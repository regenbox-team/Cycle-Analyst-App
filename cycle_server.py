...
def create_app(
    ...
    *,
    ...
    from app.routes import core as routes_core, sessions as routes_sessions, admin as routes_admin, modes as routes_modes, gps as routes_gps, tiles as routes_tiles, tracks as routes_tracks, game as routes_game, sys as routes_sys, users as routes_users, settings as routes_settings
